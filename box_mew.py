...
from airtest.core.api import swipe, exists
...
def touch_mewlist_images(
    ...
    """
    downloaded_images 폴더 내 mewList 썸네일 이미지를 순서대로 터치
    ...
    for idx, img_file in enumerate(mewlist_images):
        ...
        try:
            ...
            while not touched and attempts < max_swipe_attempts:
                try:
                    touch_template(Template(img_path, threshold=0.93))
